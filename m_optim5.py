...
import optax
import argparse
from m_class import Env1 as Env, Optclasspl_dis1
...
def main():
    ...
    prodvec = jax.vmap(producer, in_axes=(0, None, None, Env(None, None, None, 0, None, None, None, None, None, None, None, None, None)))


    result = prodvec(powers, effgradfn, solver, env)
